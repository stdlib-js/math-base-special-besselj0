...
```javascript
import j0 from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-besselj0@v0.3.1-deno/mod.js';
```
...
import besselj0 from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-besselj0@v0.3.1-deno/mod.js';
